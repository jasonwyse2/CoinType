...
class indicator:
    def __init__(self,):
        pass
    def get_commission_signal(self,position_signal):
    ...
    def get_return_for_unitTime(self,total_return, datetime_focused, start_time, end_time, minutes_in_uninTime =24 * 60):
        last_time_point = start_time
        # datetime_focused = datetime_focused.iloc[:, 0]
        cur_time_point = tool.currentTime_forward_delta(start_time, minutes_in_uninTime)
        ...
        while last_time_point < end_time:
            ...
            cur_time_point = tool.currentTime_forward_delta(cur_time_point, minutes_in_uninTime)
            # print('%s'%currTime)
